...
from qtpy.QtCore import QDir, QFileInfo, Qt

from ensync.simple.downloadwidget import DownloadWidget
from ensync.simple.ui_downloadmanagerwidget import Ui_DownloadManagerWidget
